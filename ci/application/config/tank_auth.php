...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'WC3 FFA Replays';
$config['webmaster_email'] = 'rabbitXIII';
...
$config['recaptcha_public_key'] = '6LcGZ9USAAAAAGCb6l1Qz1SbctM_bshQVzntPISZ';
$config['recaptcha_private_key'] = '6LcGZ9USAAAAAG2gMjNtOtEXfZOlbbb3GJGc2Sos';
