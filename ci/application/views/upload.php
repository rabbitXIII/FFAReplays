...
<head>
<meta charset="utf-8">
<title>WC3 FFA Replays Upload</title>
...
<div class="container">
    <div class="page-header">
        <h1>WC3 FFA Replays Upload</h1>
    </div>
    <blockquote>
        <p>Upload replays here! Drag'n Drop your files (supports multiple!)<br /></p>
    </blockquote>
    <br>
    <!-- The file upload form used as target for the file upload widget -->
    <?=anchor("/welcome","home")?>
    <form id="fileupload" action="<?=base_url()?>index.php/uploader/upload" method="POST" enctype="multipart/form-data">
